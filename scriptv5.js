        ...
        if (mode) {
            switch (mode) {
                case "light-mode":
                    ...
                    if (navLogo) navLogo.src = `${domain}/images/lupos-artLogobyDesigner.png`;
                    if (footerLogo) footerLogo.src = `${domain}/images/lupos-artLogobyDesigner.png`;
                    break;
                case "dark-mode":
                    body?.classList.add("dark");
                    if (navLogo) navLogo.src = `${domain}/images/logo3.png`;
                    if (footerLogo) footerLogo.src = `${domain}/images/logo3.png`;
                    break;
                default:
                    break;
            }
